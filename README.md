...
Tout est rangé dans un seul fichier SQLite (`phototri.sqlite`), un format public que
...
```bash
python secours_donnees.py "%APPDATA%\PhotoTri\phototri.sqlite" --dossier export
```
